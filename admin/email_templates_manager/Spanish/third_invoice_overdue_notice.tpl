...
#subject=Ultimo aviso: abono de factura fuera de plazo
#lang=
<p>Estimado {$client_name},</p>
<p>Este es el tercer y &uacute;ltimo aviso para recordarle que el abono de la factura n&uacute;mero {$invoice_num}, que fue generada con fecha {$invoice_date_created}, est&aacute; fuera de plazo. En no abono de la factura conllevar&aacute; la suspensi&oacute;n de la cuenta.</p>
